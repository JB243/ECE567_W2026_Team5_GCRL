...
from jaxgcrl.agents import CRL, CRL_EMA, CRL_EMA_GOAL, CRL_EMA_HER, CRL_LEARNTEMP, PPO, SAC, TD3

from .env import legal_envs

# agent configurations
AgentConfig = Union[CRL, CRL_EMA, CRL_EMA_GOAL, CRL_EMA_HER, CRL_LEARNTEMP, PPO, SAC, TD3]
