...
@dataclass
class CRL_EMA:
    """CRL with EMA-smoothed target critic for actor loss.

    Maintains an exponential moving average of the critic parameters.
    The actor loss is computed against this smoothed critic, which provides
    a more stable optimization target."""
